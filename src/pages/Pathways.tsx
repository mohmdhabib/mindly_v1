...
export function Pathways() {
  ...
  const [selectedTopic, setSelectedTopic] = useState<{ moduleId: number; topicId: number } | null>(null);
...
`,
          resources: [
            { title: "Khan Academy - Number Systems Course", url: "https://www.khanacademy.org/math/arithmetic" },
            { title: "MIT OpenCourseWare - Number Systems", url: "https://ocw.mit.edu/courses/mathematics/" },
            { title: "Interactive Number Line Tool", url: "https://www.geogebra.org/m/qbx5mpk9" },
            { title: "Video: Number Systems Explained", url: "https://www.youtube.com/watch?v=rYg45ZJ2Aak" },
            { title: "Number Theory Practice Problems", url: "https://artofproblemsolving.com/wiki/index.php/Number_theory" },
            { title: "Real Numbers Interactive Visualization", url: "https://www.desmos.com/calculator" },
            { title: "Research Paper: History of Number Systems", url: "https://www.maa.org/press/periodicals/convergence/mathematical-treasure-number-systems" },
            { title: "Number Systems in Computer Science", url: "https://www.geeksforgeeks.org/number-system-and-base-conversions/" },
            { title: "Interactive Exercises - IXL Math", url: "https://www.ixl.com/math/number-systems" }
          ]
        },
        2: {
...
`,
          resources: [
            { title: "Khan Academy - Arithmetic Operations", url: "https://www.khanacademy.org/math/arithmetic-home/arithmetic" },
            { title: "IXL Math - Practice Problems", url: "https://www.ixl.com/math/arithmetic" },
            { title: "Math Games for Basic Operations", url: "https://www.mathplayground.com/" }
          ]
        },
        3: {
...
`,
          resources: [
            ...
            { title: "Visual Fractions Learning", url: "https://www.visualfractions.com/" },
            { title: "Fraction/Decimal Games", url: "https://www.mathgames.com/fractions" }
          ]
        },
        4: {
          title: "Percentages",
...
`,
          resources: [
            { title: "Khan Academy - Percentages", url: "https://www.khanacademy.org/math/pre-algebra/pre-algebra-ratios-rates/pre-algebra-percent-problems/v/finding-percentages-example" },
            { title: "Percentage Calculator", url: "https://percentagecalculator.net/" },
            { title: "Real World Percentage Problems", url: "https://www.mathsisfun.com/percentage.html" }
          ]
        }
      },
...
`,
          resources: [
            { title: "Khan Academy - Variables", url: "https://www.khanacademy.org/math/algebra/introduction-to-algebra" },
            { title: "Algebra Basics", url: "https://www.purplemath.com/modules/variable.htm" },
            { title: "Interactive Algebra", url: "https://www.geogebra.org/algebra" }
          ]
        },
        2: {
...
`,
          resources: [
            ...
            { title: "Linear Equation Solver", url: "https://www.mathway.com/Algebra" },
            { title: "Practice Problems", url: "https://www.algebra.com/algebra/homework/linear" }
          ]
        },
        3: {
...
`,
          resources: [
            { title: "Khan Academy - Quadratic Equations", url: "https://www.khanacademy.org/math/algebra/quadratic-equations" },
            { title: "Interactive Quadratic Explorer", url: "https://www.desmos.com/calculator/cahqdxeshd" },
            { title: "Practice and Examples", url: "https://www.mathsisfun.com/algebra/quadratic-equation.html" }
          ]
        }
      }
    },
...
`,
          resources: [
            ...
            { title: "Physics Classroom", url: "https://www.physicsclassroom.com/Physics-Tutorial/Newton-s-Laws" },
            { title: "Interactive Simulations", url: "https://phet.colorado.edu/en/simulations/category/physics/motion" }
          ]
        },
        2: {
...
`,
          resources: [
            ...
            { title: "Energy Simulations", url: "https://phet.colorado.edu/en/simulations/energy-forms-and-changes" },
...
`,
          resources: [
            ...
            { title: "State Management Guide", url: "https://www.taniarascia.com/redux-react-guide/" },
            { title: "React State Management", url: "https://www.patterns.dev/posts/react-state-management/" }
          ]
        }
      }
    }
    ...
    1: [
      {
        ...
        topics: [
          { id: 1, title: 'Number Systems', duration: '2 hours', completed: false },
          { id: 2, title: 'Basic Arithmetic', duration: '3 hours', completed: false },
          { id: 3, title: 'Fractions and Decimals', duration: '2.5 hours', completed: false },
          { id: 4, title: 'Percentages', duration: '2 hours', completed: false }
        ],
        resources: ['Practice worksheets', 'Video lectures', 'Interactive problems'],
        duration: '10 hours',
        progress: 0
      },
      {
        ...
        topics: [
          { id: 1, title: 'Variables and Constants', duration: '2 hours', completed: false },
          { id: 2, title: 'Linear Equations', duration: '3 hours', completed: false },
          { id: 3, title: 'Quadratic Equations', duration: '4 hours', completed: false }
        ],
      ...
      },
      {
        ...
        topics: [
          ...
          { id: 3, title: 'Angles and Lines', duration: '2 hours', completed: false }
        ],
        resources: ['Interactive diagrams', 'Video lessons', 'Practice exercises'],
        duration: '8 hours',
        progress: 0
      }
    ],
    2: [
      {
        ...
        topics: [
          { id: 1, title: 'Newton\'s Laws', duration: '3 hours', completed: false },
          { id: 2, title: 'Work and Energy', duration: '3 hours', completed: false },
          { id: 3, title: 'Momentum and Collisions', duration: '2.5 hours', completed: false },
          { id: 4, title: 'Rotational Motion', duration: '3 hours', completed: false }
        ],
        resources: ['Physics simulator', 'Problem sets', 'Video demonstrations'],
        duration: '12 hours',
        progress: 0
      },
      {
        ...
        topics: [
          { id: 1, title: 'Temperature and Heat', duration: '2 hours', completed: false },
          { id: 2, title: 'Laws of Thermodynamics', duration: '4 hours', completed: false },
          { id: 3, title: 'Heat Engines', duration: '3 hours', completed: false }
        ],
        resources: ['Interactive simulations', 'Lab exercises', 'Practice problems'],
        duration: '9 hours',
        progress: 0
      },
      {
        ...
        topics: [
          { id: 1, title: 'Wave-Particle Duality', duration: '3 hours', completed: false },
          { id: 2, title: 'Quantum States', duration: '3 hours', completed: false },
          { id: 3, title: 'Schrödinger Equation', duration: '4 hours', completed: false }
        ],
        resources: ['Quantum visualizations', 'Mathematical tools', 'Research papers'],
        duration: '10 hours',
        progress: 0
      }
    ],
    3: [
      {
        ...
        topics: [
          { id: 1, title: 'React Fundamentals', duration: '4 hours', completed: false },
          { id: 2, title: 'State Management', duration: '3 hours', completed: false },
          { id: 3, title: 'Component Patterns', duration: '3 hours', completed: false },
          { id: 4, title: 'Routing & Navigation', duration: '2 hours', completed: false }
        ],
      ...
      },
      {
        ...
        topics: [
          { id: 1, title: 'Node.js Basics', duration: '3 hours', completed: false },
          { id: 2, title: 'Express Framework', duration: '4 hours', completed: false },
          { id: 3, title: 'Database Integration', duration: '4 hours', completed: false },
          { id: 4, title: 'API Development', duration: '3 hours', completed: false }
        ],
      ...
      },
      {
        ...
        topics: [
          { id: 1, title: 'SQL Fundamentals', duration: '3 hours', completed: false },
          { id: 2, title: 'Schema Design', duration: '4 hours', completed: false },
          { id: 3, title: 'Indexing & Performance', duration: '3 hours', completed: false },
          { id: 4, title: 'Data Migration', duration: '2 hours', completed: false }
        ],
  ...
  const featuredPaths = [
    {
      ...
      description: 'From basic arithmetic to advanced calculus, master all mathematical concepts',
      ...
      outcomes: ['Algebra mastery', 'Calculus understanding', 'Problem solving'],
      image: 'math-pathway',
    ...
    },
    {
      ...
      description: 'Explore the laws of nature from classical mechanics to quantum physics',
  ...
  const pathsByCategory = {
    mathematics: [
      { title: 'Algebra Mastery', difficulty: 'Beginner', duration: '6 weeks', rating: 4.7, students: 1200 },
      { title: 'Calculus Complete', difficulty: 'Intermediate', duration: '8 weeks', rating: 4.8, students: 890 },
      { title: 'Statistics & Probability', difficulty: 'Intermediate', duration: '7 weeks', rating: 4.6, students: 650 }
    ],
    science: [
      { title: 'Chemistry Basics', difficulty: 'Beginner', duration: '5 weeks', rating: 4.5, students: 780 },
      { title: 'Biology Fundamentals', difficulty: 'Beginner', duration: '6 weeks', rating: 4.7, students: 920 },
      { title: 'Advanced Physics', difficulty: 'Advanced', duration: '12 weeks', rating: 4.9, students: 340 }
    ],
    programming: [
      { title: 'Python for Beginners', difficulty: 'Beginner', duration: '8 weeks', rating: 4.8, students: 2100 },
      { title: 'JavaScript Mastery', difficulty: 'Intermediate', duration: '10 weeks', rating: 4.7, students: 1560 },
      { title: 'Data Structures & Algorithms', difficulty: 'Advanced', duration: '14 weeks', rating: 4.9, students: 890 }
    ]
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Follow curated learning paths designed by experts. Progress step-by-step from beginner to mastery.
          </p>
        </div>
              ...
              <div className="max-w-6xl mx-auto bg-white dark:bg-gray-900 rounded-lg shadow-xl">
                <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                      {featuredPaths.find(p => p.id === selectedPathway)?.title}
                    </h2>
                ...
                <div className="p-6 space-y-8">
                  {moduleData[selectedPathway]?.map((module, index) => (
                    <div key={module.id} className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6">
                        ...
                        {module.topics.map((topic) => (
                          <div key={topic.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 flex items-center justify-between">
                            ...
                            <Button 
                              ...
                              size="sm"
                              onClick={() => {
                                setSelectedTopic({ moduleId: module.id, topicId: topic.id });
                                if (selectedPathway) {
                                  setSelectedTopic({ moduleId: module.id, topicId: topic.id });
                                  setShowBlog(true);
                                }
                      ...
                      {selectedTopic?.moduleId === module.id && showBlog && (
                        <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg">
                          <h4 className="text-lg font-semibold mb-4">
                            {blogData[selectedPathway]?.[module.id]?.[selectedTopic.topicId]?.title}
                          </h4>
                          <div className="prose dark:prose-invert max-w-none">
                            {blogData[selectedPathway]?.[module.id]?.[selectedTopic.topicId]?.content}
                          </div>
                          <div className="mt-6">
                            <h5 className="font-semibold mb-2">Additional Resources:</h5>
                            <ul className="space-y-2">
                              {blogData[selectedPathway]?.[module.id]?.[selectedTopic.topicId]?.resources.map((resource, idx) => (
                                <li key={idx}>
                                  <a 
                                    href={resource.url}
                                    target="_blank"
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-8 lg:grid-cols-3">
                {featuredPaths.map((path) => (
                  <Card key={path.id} className="group cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-0 overflow-hidden">
                      ...
                      {path.progress > 0 && (
                        <div className="mb-4">
                          <div className="flex items-center justify-between text-sm mb-1">
                            ...
                            <span className="text-gray-600 dark:text-gray-300">{path.progress}%</span>
                          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <Card className="p-6 text-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-800">
                <div className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-2">24</div>
                <div className="text-sm text-blue-600 dark:text-blue-500">Total Pathways</div>
              </Card>
              <Card className="p-6 text-center bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200 dark:border-green-800">
                <div className="text-3xl font-bold text-green-700 dark:text-green-400 mb-2">12K+</div>
                <div className="text-sm text-green-600 dark:text-green-500">Active Learners</div>
              </Card>
              <Card className="p-6 text-center bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-800">
                <div className="text-3xl font-bold text-purple-700 dark:text-purple-400 mb-2">95%</div>
                <div className="text-sm text-purple-600 dark:text-purple-500">Completion Rate</div>
              </Card>
              <Card className="p-6 text-center bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-orange-200 dark:border-orange-800">
                <div className="text-3xl font-bold text-orange-700 dark:text-orange-400 mb-2">4.8</div>
          ...
          <div className="grid gap-8 lg:grid-cols-4">
              ...
              <Card className="p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                ...
                <div className="space-y-2">
                  {['Beginner', 'Intermediate', 'Advanced'].map((level) => (
                    <Button key={level} variant="ghost" className="w-full justify-start text-gray-700 dark:text-gray-300">
                      {level}
                    </Button>
                  ))}
                </div>
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                  {activeFilter === 'all' ? 'All Pathways' : categories.find(c => c.id === activeFilter)?.name}
                </h2>
              ...
              {activeFilter !== 'all' && pathsByCategory[activeFilter as keyof typeof pathsByCategory] && (
                <div className="grid gap-6 md:grid-cols-2">
                  {pathsByCategory[activeFilter as keyof typeof pathsByCategory].map((path, index) => (
              ...
              {activeFilter === 'all' && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Select a category from the sidebar to explore available learning pathways.
                  </p>
                </div>
              )}
            </div>
        ...
        {activeTab === 'my-paths' && (
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {myPaths.map((path, index) => (
              <Card key={index} className="p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
