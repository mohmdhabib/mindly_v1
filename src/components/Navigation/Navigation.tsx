...
export function Navigation() {
  ...
  const { session, signOut } = useAuth(); // Import the signOut function from auth context
          ...
          <div className="flex items-center space-x-3">
            ...
            {session ? (
              ...
              <Link to="/login">
                <Button
                  variant="ghost"
                  className="hidden md:flex items-center px-4 py-2 rounded-full hover:bg-white/90 dark:hover:bg-slate-800/90 hover:shadow-lg transition-all duration-300 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white"
                >
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              {session ? (
                ...
                <Link to="/login">
                  <Button
                    variant="ghost"
                    className="w-full justify-start px-4 py-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 text-slate-700 dark:text-slate-300"
                    onClick={() => setIsMenuOpen(false)}
                  >
